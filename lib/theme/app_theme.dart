...
// Modern Navy & Black Theme with Forest Green Accents
class AppTheme {
  // Primary Colors - Navy Blue & Forest Green
  static const Color primaryNavy = Color(0xFF1E3A8A); // Navy Blue
  static const Color primaryForest = Color(0xFF065F46); // Forest Green
  static const Color accentBurgundy = Color(0xFF9F1239); // Burgundy Accent
  
  // Dark Theme Colors
  static const Color darkBackground = Color(0xFF000000); // Black
  static const Color darkSurface = Color(0xFF1A1A1A); // Dark Black
  static const Color darkCardBackground = Color(0xFF2D2D2D); // Dark Gray
  ...
  static const Color darkBorderLight = Color(0xFF404040); // Dark Border
  static const Color darkBorderMedium = Color(0xFF555555); // Medium Dark Border
  ...
  static const LinearGradient primaryGradient = LinearGradient(
    colors: [primaryNavy, primaryForest],
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );
  
  static const LinearGradient darkCardGradient = LinearGradient(
    colors: [darkSurface, Color(0xFF3A3A3A)],
...
class CustomColors {
  static const Color categoryTag = Color(0xFF1E3A8A); // Navy Blue Background
  static const Color categoryText = Color(0xFF1E3A8A); // Navy Blue Text
  static const Color ratingStar = Color(0xFF065F46); // Forest Green
  static const Color onlineIndicator = Color(0xFF065F46); // Forest Green
  static const Color offlineIndicator = Color(0xFF808080); // Gray
  static const Color premiumBadge = Color(0xFF065F46); // Forest Green Background
  static const Color premiumText = Color(0xFF1E3A8A); // Navy Blue Text
}
